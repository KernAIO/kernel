...
export const coreEvents = {
  ...
  workspaceCreated: defineEvent(
    'core.workspace.created',
    z.object({ workspaceId: WorkspaceId, slug: z.string(), createdBy: UserId }),
  ),
  workspaceUpdated: defineEvent(
    'core.workspace.updated',
    z.object({ workspaceId: WorkspaceId, fields: z.array(z.string()) }),
  ),
  workspaceArchived: defineEvent('core.workspace.archived', z.object({ workspaceId: WorkspaceId })),
  memberJoined: defineEvent(
    'core.member.joined',
    z.object({ workspaceId: WorkspaceId, userId: UserId, role: BuiltinRole }),
  ),
  memberUpdated: defineEvent(
    'core.member.updated',
    z.object({ workspaceId: WorkspaceId, userId: UserId, role: BuiltinRole }),
  ),
  ...
  permissionsChanged: defineEvent(
    'core.permissions.changed',
    z.object({ workspaceId: WorkspaceId, userIds: z.array(UserId).nullable() }),
  ),
  moduleEnabled: defineEvent(
    'core.module.enabled',
    z.object({ workspaceId: WorkspaceId, moduleId: z.string(), enabled: z.boolean() }),
  ),
  moduleSettingsUpdated: defineEvent(
    'core.module.settings_updated',
    z.object({ workspaceId: WorkspaceId, moduleId: z.string() }),
  ),
  notificationCreated: defineEvent(
    'core.notification.created',
    z.object({
      notificationId: Id,
      userId: UserId,
